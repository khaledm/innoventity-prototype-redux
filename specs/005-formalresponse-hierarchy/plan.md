...
**✅ Principle 2 — Quality is Non-Negotiable**: ~70 new integration tests cover all four submit endpoints and GetBids (happy path, wrong actor type, duplicate, owns the innovation, innovation not found/not published, invalid location, rationale/proposal boundary values, contiguity/max-year boundaries). Stryker added for all new feature files. Mutation thresholds: break: 71, low: 71, high: 80 (measured aggregate 74.95% as of 2026-07-18).
